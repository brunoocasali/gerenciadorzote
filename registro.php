<?php session_start(); if (isset($_SESSION[ 'Controle'])) { echo $a=( $_SESSION[ 'Controle']=="erro_cadastro" ) ? "<div class='alert alert-danger alert-dismissable'>
...
<body>
    <div class="container" style="padding-top:10%;">
        ...
        <form class="form-signin" style="margin-bottom:9px" action="./funcoes/registrar.php" method="POST">
